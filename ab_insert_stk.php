...
$fileDIR = $_FILES['stkab']['tmp_name'];
//echo $fileDIR;

// Start the session (if not already started)
session_start();

$fileName = $_FILES['stkab']['name'];
...
$sql = 'INSERT INTO ab_master (mrp_whs, reference, part_no, part_description, dely_pattern, supplier, po_number, delivery_qty, ws_cd, ship_to_location, dateeta, transdt, processdt, rcvdt, rcvqty, jocno, outstanding_qty, rcv_status, batch_id, buyer_name, export_date) VALUES ';
...
//$sql = str_replace(",", "");
//echo $sql;	
if (mysqli_query($conn, "TRUNCATE TABLE ab_master")){
...
header("Location: ab_upgrade_db.php");
exit();
?>