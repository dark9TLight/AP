...
$fileDIR = $_FILES['stkautojit']['tmp_name'];
//echo $fileDIR;

// Start the session (if not already started)
session_start();

$fileNameautojitt = $_FILES['stkautojit']['name'];

// Store $fileName in a session variable
$_SESSION['uploaded_file_autojitt'] = $fileNameautojitt;
...
$sql = 'INSERT INTO autojit_master (mrp_whs, reference, partno, partdesc, delypattern, supplier, pono, deliverqty, ws_cd, shiptolocation, dateeta, transdt, processdt, rcvdt, rcvqty, joc_no, outstandingqty, rcvstat, batch_id, buyer_name, export_date) VALUES ';
...
//$sql = str_replace(",", "");
//echo $sql;	
if (mysqli_query($conn, "TRUNCATE TABLE autojit_master")){
